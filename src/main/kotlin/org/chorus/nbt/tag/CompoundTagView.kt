...
class CompoundTagView(private val delegate: CompoundTag) : CompoundTag() {
    ...
    override fun putList(name: String?, listTag: ListTag<out Tag?>?): CompoundTag? {
        throw UnsupportedOperationException()
    }
    ...
    override fun putBoolean(string: String?, `val`: Boolean): CompoundTag? {
        throw UnsupportedOperationException()
    }
    ...
    override fun getList(name: String?): ListTag<out Tag?>? {
