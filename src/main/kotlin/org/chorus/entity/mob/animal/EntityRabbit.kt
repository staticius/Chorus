 ...
 */
class EntityRabbit(chunk: IChunk?, nbt: CompoundTag) : EntityAnimal(chunk, nbt), EntityWalkable {
    override fun getIdentifier(): String {
        return EntityID.Companion.RABBIT
    }
    ...
    public override fun requireBehaviorGroup(): IBehaviorGroup {
        return BehaviorGroup(
            ...
            Set.of<IBehavior>(
                ...
                Behavior(
                    EntityBreedingExecutor<EntityRabbit>(EntityRabbit::class.java, 16, 100, 0.5f),
            ...
            Set.of<IController>(HoppingController(5), LookController(true, true), FluctuateController()),
