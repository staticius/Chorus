...
object Fishing {
    ...
    fun getFishingResult(fortuneLevel: Int, lureLevel: Int): Item? {
        val treasureChance = NukkitMath.clamp(0.05f + 0.01f * fortuneLevel - 0.01f * lureLevel, 0f, 1f)
        val junkChance = NukkitMath.clamp(0.05f - 0.025f * fortuneLevel - 0.01f * lureLevel, 0f, 1f)
        val fishChance = NukkitMath.clamp(1 - treasureChance - junkChance, 0f, 1f)
