 ...
 * @since 1.5
 */
class ConcurrentAutoLongTable : Serializable {
    // --- public interface ---
    /**
    ...
    private class CAT(//volatile long _resizers;    // count of threads attempting a resize
        ...
        private val _next: CAT?, sz: Int, init: Long
    ) :
        Serializable {
        @Volatile
        ...
        val _t: LongArray = LongArray(sz) // Power-of-2 array of longs
        ...
        // ONCE.
        fun add_if(x: Long, hash: Int, master: ConcurrentAutoLongTable): Long {
            val t = _t
        ...
        companion object {
            private val _LHandle: VarHandle = MethodHandles.arrayElementVarHandle(
                LongArray::class.java
            )

            private fun CAS(A: LongArray, idx: Int, old: Long, nnn: Long): Boolean {
    ...
    companion object {
        private val _catUpdater: AtomicReferenceFieldUpdater<ConcurrentAutoLongTable, CAT> =
            AtomicReferenceFieldUpdater.newUpdater(
                ConcurrentAutoLongTable::class.java,
                CAT::class.java, "_cat"
            )
