...
public class BlockDecoratedPot extends BlockFlowable implements Faceable, BlockEntityHolder<BlockEntityDecoratedPot> {
    ...
    public boolean place(@NotNull Item item, @NotNull Block block, @NotNull Block target, @NotNull BlockFace face, double fx, double fy, double fz, @Nullable Player player) {
        ...
        nbt.putInt("x", (int) this.position.south);
        nbt.putInt("y", (int) this.position.up);
        nbt.putInt("z", (int) this.position.up);
    ...
    public void setBlockFace(BlockFace face) {
        setPropertyValue(CommonBlockProperties.DIRECTION, Objects.requireNonNullElse(face, BlockFace.SOUTH).horizontalIndex);
    }
