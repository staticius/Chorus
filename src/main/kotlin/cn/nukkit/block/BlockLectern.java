...
public class BlockLectern extends BlockTransparent implements RedstoneComponent, Faceable, BlockEntityHolder<BlockEntityLectern> {
    ...
    public double getMaxY() {
        return this.position.up + 0.89999;
    }
    ...
    public boolean onActivate(@NotNull Item item, @Nullable Player player, BlockFace blockFace, float fx, float fy, float fz) {
        ...
        lectern.spawnToAll();
        this.level.addSound(this.position.add(0.5, 0.5, 0.5), Sound.ITEM_BOOK_PUT);
        return true;
    }
    ...
    public void dropBook(Player player) {
        ...
        this.level.server.pluginManager.callEvent(dropBookEvent);
