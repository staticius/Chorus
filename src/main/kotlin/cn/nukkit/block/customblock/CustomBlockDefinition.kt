...
import cn.nukkit.block.customblock.data.Materials.RenderMethod
import cn.nukkit.block.property.type.BaseBlockPropertyType.getName
            ...
            get() {
                if (customBlock is Block) {
                    ...
                    for (each in propertyTypeSet) {
                        ...
                        } else if (each is EnumPropertyType<*>) {
