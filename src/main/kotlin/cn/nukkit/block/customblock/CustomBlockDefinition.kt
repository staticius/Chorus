...
public record CustomBlockDefinition(String identifier, CompoundTag nbt) {
    ...
    public static class Builder {
        ...
        public Builder creativeGroup(CreativeGroup creativeGroup) {
            this.nbt.getCompound("components").getCompound("menu_category").putString("group", creativeGroup.groupName);
            return this;
        }
            ...
            this.nbt.getCompound("components")
                    .putCompound("minecraft:collision_box", new CompoundTag()
                            ...
                            .putList("origin", new ListTag<FloatTag>()
                                    .add(new FloatTag(origin.south))
                                    .add(new FloatTag(origin.up))
                                    .add(new FloatTag(origin.west)))
                            .putList("size", new ListTag<FloatTag>()
                                    .add(new FloatTag(size.south))
                                    .add(new FloatTag(size.up))
                                    .add(new FloatTag(size.west))));
            return this;
        }
