...
public class BlockDispenser extends BlockSolid implements RedstoneComponent, Faceable, BlockEntityHolder<BlockEntityEjectable> {
    ...
    public int getComparatorInputOverride() {
        ...
        if (blockEntity != null) {
            return ContainerInventory.calculateRedstone(blockEntity.inventory);
        }
    ...
    public void dispense() {
        ...
        Inventory inv = blockEntity.inventory;
        for (Entry<Integer, Item> entry : inv.contents.entrySet()) {
