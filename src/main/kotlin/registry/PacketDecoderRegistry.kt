...
class PacketDecoderRegistry : IRegistry<Int, PacketDecoder<out DataPacket>?, PacketDecoder<out DataPacket>> {
    ...
    private fun registerPackets() {
        ...
        this.register(ProtocolInfo.CLIENT_CACHE_STATUS_PACKET, ClientCacheStatusPacket) // 129
        ...
        this.register(ProtocolInfo.DEBUG_INFO_PACKET, DebugInfoPacket) // 155
        ...
        this.register(ProtocolInfo.CODE_BUILDER_SOURCE_PACKET, CodeBuilderSourcePacket) // 178
        ...
        this.register(ProtocolInfo.CHANGE_MOB_PROPERTY_PACKET, ChangeMobPropertyPacket) // 182
