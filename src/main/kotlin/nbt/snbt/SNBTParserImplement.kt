...
class SNBTParserImplement(
    ...
    fun Value() {
        ...
        if (isTreeBuildingEnabled) {
            Value1 = org.chorus_oss.chorus.nbt.snbt.ast.Value()
    ...
    fun KeyValuePair() {
        ...
        if (isTreeBuildingEnabled) {
            KeyValuePair2 = org.chorus_oss.chorus.nbt.snbt.ast.KeyValuePair()
    ...
    fun ByteArrayNBT() {
        ...
        if (isTreeBuildingEnabled) {
            ByteArrayNBT3 = org.chorus_oss.chorus.nbt.snbt.ast.ByteArrayNBT()
    ...
    fun IntArrayNBT() {
        ...
        if (isTreeBuildingEnabled) {
            IntArrayNBT4 = org.chorus_oss.chorus.nbt.snbt.ast.IntArrayNBT()
    ...
    fun ListNBT() {
        ...
        if (isTreeBuildingEnabled) {
            ListNBT5 = org.chorus_oss.chorus.nbt.snbt.ast.ListNBT()
    ...
    fun CompoundNBT() {
        ...
        if (isTreeBuildingEnabled) {
            CompoundNBT6 = org.chorus_oss.chorus.nbt.snbt.ast.CompoundNBT()
    ...
    fun Root() {
        ...
        var Root7: Root? = null
        if (isTreeBuildingEnabled) {
            Root7 = org.chorus_oss.chorus.nbt.snbt.ast.Root()
            openNodeScope(Root7)
        }
